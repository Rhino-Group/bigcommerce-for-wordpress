...
<section class="bc-account-page">
	...
	<form class="bc-form bc-form-2col bc-account-form--register <?php if ( ! empty( $errors ) ) { echo 'bc-form--has-errors'; } ?>" action="" enctype="multipart/form-data" method="post" data-js="bc-dynamic-fields">
		...
		<input type="email" name="bc-register[email]" id="bc-account-register-email" value="<?php echo esc_attr( $defaults[ 'email' ] ); ?>" data-form-field="bc-form-field-email" required="required" aria-required="true" autocomplete="email" <?php if ( in_array( 'email', $errors ) ) { echo 'aria-invalid="true"'; } ?>>
		</label>
		...
		<label class="bc-form__control bc-form-2col__control bc-form-2col__control--left <?php if ( in_array( 'new_password', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-password">
			...
			<input type="password" name="bc-register[new_password]" id="bc-account-register-password" value=""  data-form-field="bc-form-field-new_password" required="required" aria-required="true" autocomplete="new-password" <?php if ( in_array( 'new_password', $errors ) ) { echo 'aria-invalid="true"'; } ?>>
		</label>
		...
		<label class="bc-form__control bc-form-2col__control bc-form-2col__control--right <?php if ( in_array( 'confirm_password', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-confirm-password">
			...
			<input type="password" name="bc-register[confirm_password]" id="bc-account-register-confirm-password" value=""  data-form-field="bc-form-field-confirm_password" required="required" aria-required="true" autocomplete="new-password" <?php if ( in_array( 'confirm_password', $errors ) ) { echo 'aria-invalid="true"'; } ?>>
		</label>
		...
		<label class="bc-form__control bc-form-2col__control bc-form-2col__control--left <?php if ( in_array( 'first_name', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-firstname">
			...
			<input type="text" name="bc-register[first_name]" id="bc-account-register-firstname" value="<?php echo esc_attr( $defaults[ 'first_name' ] ); ?>"  data-form-field="bc-form-field-first_name" required="required" aria-required="true" autocomplete="given-name" <?php if ( in_array( 'first_name', $errors ) ) { echo 'aria-invalid="true"'; } ?>>
		</label>
		...
		<label class="bc-form__control bc-form-2col__control bc-form-2col__control--right <?php if ( in_array( 'last_name', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-lastname">
			...
			<input type="text" name="bc-register[last_name]" id="bc-account-register-lastname" value="<?php echo esc_attr( $defaults[ 'last_name' ] ); ?>"  data-form-field="bc-form-field-last_name" required="required" aria-required="true" autocomplete="family-name" <?php if ( in_array( 'last_name', $errors ) ) { echo 'aria-invalid="true"'; } ?>>
		</label>
		...
		<label class="bc-form__control bc-form-2col__control bc-form-2col__control--left <?php if ( in_array( 'street_1', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-street1">
			...
			<input type="text" name="bc-register[street_1]" id="bc-account-register-street1" value="<?php echo esc_attr( $defaults[ 'street_1' ] ); ?>"  data-form-field="bc-form-field-street_1" required="required" aria-required="true" autocomplete="address-line1" <?php if ( in_array( 'street_1', $errors ) ) { echo 'aria-invalid="true"'; } ?>>
		</label>
		...
		<label class="bc-form__control bc-form-2col__control bc-form-2col__control--right <?php if ( in_array( 'street_2', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-street2">
			...
			<input type="text" name="bc-register[street_2]" id="bc-account-register-street2" value="<?php echo esc_attr( $defaults[ 'street_2' ] ); ?>" data-form-field="bc-form-field-street_2" autocomplete="address-line2" <?php if ( in_array( 'street_2', $errors ) ) { echo 'aria-invalid="true"'; } ?>>
		</label>
		...
		<label class="bc-form__control bc-form-2col__control bc-form-2col__control--left <?php if ( in_array( 'company', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-company">
			...
			<input type="text" name="bc-register[company]" id="bc-account-register-company" value="<?php echo esc_attr( $defaults[ 'company' ] ); ?>" data-form-field="bc-form-field-company" autocomplete="organization" <?php if ( in_array( 'company', $errors ) ) { echo 'aria-invalid="true"'; } ?>>
		</label>
		...
		<label class="bc-form__control bc-form-2col__control bc-form-2col__control--right <?php if ( in_array( 'city', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-city">
			...
			<input type="text" name="bc-register[city]" id="bc-account-register-city" value="<?php echo esc_attr( $defaults[ 'city' ] ); ?>" data-form-field="bc-form-field-city" required="required" aria-required="true" autocomplete="address-level2" <?php if ( in_array( 'city', $errors ) ) { echo 'aria-invalid="true"'; } ?>>
		</label>
		...
		<label class="bc-form__control bc-form-2col__control bc-form-2col__control--left <?php if ( in_array( 'state', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-state" data-js="bc-dynamic-state">
			...
			<?php if ( ! empty( $states ) ) { ?>
				<select id="bc-account-register-state" name="bc-register[state]" data-js="bc-dynamic-state-control"  data-form-field="bc-form-field-state" required="required" aria-required="true" autocomplete="address-level1" <?php if ( in_array( 'state', $errors ) ) { echo 'aria-invalid="true"'; } ?>>
			...
			<?php } else { ?>
				<input type="text" id="bc-account-register-state" name="bc-register[state]" value="<?php echo esc_attr( $defaults[ 'state' ] ); ?>" data-js="bc-dynamic-state-control"  data-form-field="bc-form-field-state" required="required" aria-required="true" autocomplete="address-level1" <?php if ( in_array( 'state', $errors ) ) { echo 'aria-invalid="true"'; } ?> />
			<?php } ?>
		</label>
		...
		<label class="bc-form__control bc-form-2col__control bc-form-2col__control--right <?php if ( in_array( 'zip', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-zip">
			...
			<input type="text" name="bc-register[zip]" id="bc-account-register-zip" value="<?php echo esc_attr( $defaults[ 'zip' ] ); ?>"  data-form-field="bc-form-field-zip" required="required" aria-required="true" autocomplete="postal-code" <?php if ( in_array( 'zip', $errors ) ) { echo 'aria-invalid="true"'; } ?>>
		</label>
		...
		<label class="bc-form__control bc-form-2col__control bc-form-2col__control--left <?php if ( in_array( 'country', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-country">
			...
			<select name="bc-register[country]" id="bc-account-register-country" data-js="bc-dynamic-country-select"  data-form-field="bc-form-field-country" required="required" aria-required="true" autocomplete="country" <?php if ( in_array( 'country', $errors ) ) { echo 'aria-invalid="true"'; } ?>>
		...
		<label class="bc-form__control bc-form-2col__control bc-form-2col__control--right <?php if ( in_array( 'phone', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-phone">
			...
			<input type="tel" name="bc-register[phone]" id="bc-account-register-phone" value="<?php echo esc_attr( $defaults[ 'phone' ] ); ?>"  data-form-field="bc-form-field-phone" required="required" aria-required="true" autocomplete="tel" <?php if ( in_array( 'phone', $errors ) ) { echo 'aria-invalid="true"'; } ?>>
		</label>
